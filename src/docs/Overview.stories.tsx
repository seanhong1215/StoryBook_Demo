const groups = [
  {
    ...
    components: [
      ...
      {
        name: 'Icon',
        href: './?path=/docs/general-icon--docs',
        description: '提供元件庫內建圖示，也接受自訂 SVG 內容。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    components: [
      {
        name: 'Tokens',
        href: './?path=/story/foundation-tokens--brand-colors',
        description: '共用色彩、間距、圓角、字級與陰影 token。',
      },
      {
        name: 'Localization',
        href: './?path=/story/foundation-localization--comparison',
        description: '比較英文與繁體中文語系，並示範 provider 巢狀覆寫。',
      },
    ],
  },
]
...
const guideLinks = [
  {
    step: '1',
    title: '安裝與第一個元件',
    href: './?path=/docs/guide-getting-started--docs',
    description: '設定私有 registry、安裝套件，並在 React 專案中完成第一次匯入。',
  },
  {
    step: '2',
    title: '設定主題與產品線',
    href: './?path=/story/foundation-tokens--brand-colors',
    description: '了解 design token、明暗主題與不同 product line 的覆寫方式。',
  },
  {
    step: '3',
    title: '查閱元件 API',
    href: './?path=/docs/general-button--docs',
    description: '從元件文件查看範例、狀態、props、互動測試與無障礙檢查。',
  },
]

const proofPoints = [
  '21 個可重用 React 元件，完整 TypeScript 型別。',
  '四條產品線與明暗主題共用同一套 CSS tokens。',
  '元件樣式可 tree-shake，沒有額外執行期依賴。',
  '127 個 Storybook 測試涵蓋互動流程與 axe 檢查。',
]
...
export const Overview = {
  render: () => (
    <main className="docs-page">
      <p className="docs-kicker">My Design System</p>
      <h1 className="docs-title">React 元件與設計指南</h1>
      <p className="docs-lede">
        給內部產品使用的輕量 UI library。從快速開始進行安裝與主題設定，
        或依分類查閱每個元件的使用範例、API、互動行為與無障礙規範。
      </p>

      <section className="docs-section">
        <div className="docs-section-header">
          <h2 className="docs-section-title">開始使用</h2>
      ...
      <section className="docs-section">
        <div className="docs-section-header">
          <h2 className="docs-section-title">快速範例</h2>
        </div>
...
export function App() {
  return (
    <ConfigProvider global theme="light" productLine="core">
      ...
      <section className="docs-section">
        <div className="docs-section-header">
          <h2 className="docs-section-title">設計系統概況</h2>
